...
/**
 * Primary login surface. Social sign-in (Google + GitHub) is the recommended
 * path; the email/password form is the fallback "custom" credential. Both
 * sign-in and sign-up reuse this so the providers stay in sync.
 */
export function SocialAuthButtons({ disabled }: { disabled?: boolean }) {
  ...
  async function handle(provider: Provider) {
    ...
    // spinner up until navigation happens.
  }
